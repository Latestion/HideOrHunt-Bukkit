...
public class TabC implements TabCompleter {
	...
	public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (arguments.isEmpty()) {
			arguments.add("start"); arguments.add("freeze"); arguments.add("chat"); arguments.add("reload"); arguments.add("beacon"); arguments.add("rules");
			arguments.add("spy"); arguments.add("stats"); arguments.add("stop");
